...
enum nl80211_ext_feature_index {
	...
	/**
	 * NL80211_EXT_FEATURE_ROAM_OFFLOAD is a custom addition for Infineon radios
	 * This must remain at the end of the list and must be in sync with the kernel
	 * used in the Summit radio stack
	 */
	// additional unsupported features needed to align roam_offload with kernel in Summit radio stack
	__NL80211_EXT_FEATURE_DFS_CONCURRENT,
	__NL80211_EXT_FEATURE_SPP_AMSDU_SUPPORT,
