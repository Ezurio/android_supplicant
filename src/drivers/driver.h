...
#ifdef _SDC_
// set if channel disabled due to disable_dfs
#define HOSTAPD_CHAN_DISABLED_FOR_RADAR 0x80000000
#endif
...
#ifdef _SDC_
#define WPA_DRIVER_FLAGS2_SET_SCAN_DWELL         0x8000000000000000ULL
#endif
/** Driver supports SAE authentication offload in station mode */
#define WPA_DRIVER_FLAGS2_SAE_OFFLOAD		0x4000000000000000ULL
/** Driver supports 4-way handshake offload for WPA-Personal in AP mode */
#define WPA_DRIVER_FLAGS2_4WAY_HANDSHAKE_AP_PSK	0x2000000000000000ULL
/** Driver supports SAE authentication offload in AP mode */
#define WPA_DRIVER_FLAGS2_SAE_OFFLOAD_AP	0x1000000000000000ULL
/** Driver supports FT / OKC fast roaming */
#define WPA_DRIVER_FLAGS2_ROAM_OFFLOAD		0x0800000000000000ULL
	u64 flags2;
